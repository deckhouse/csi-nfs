...
Для работы RPC-with-TLS необходимо Linux ядро старше 6.4. Проверьте версию ядра:
...
Проверьте, что ядро скомпилировано с необходимыми параметрами:
...
### Проверка конфигурации tlshd на использование TLS

Проверьте конфигурацию tlshd:
...
Создайте общий каталог NFS и настройте его:
